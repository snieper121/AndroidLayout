...
public final class DialogEditTextBinding implements ViewBinding {
  ...
  private DialogEditTextBinding(@NonNull CoordinatorLayout rootView,
      @NonNull LinearLayout linAdditional, @NonNull NestedScrollView nestedScrollView,
      @NonNull TextInputEditText textInput, @NonNull TextInputLayout til,
  ...
  public static DialogEditTextBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogEditTextBinding((CoordinatorLayout) rootView, linAdditional,
          nestedScrollView, textInput, til, tvInfo);
    }
